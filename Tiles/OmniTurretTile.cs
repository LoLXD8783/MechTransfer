...
namespace MechTransfer.Tiles
{
    public class OmniTurretTile : SimpleTileObject, INetHandler
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            Main.LocalPlayer.cursorItemIconID = PlaceItems[GetDropKind(tile.TileFrameX, tile.TileFrameY)].Item.type;
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(Mod.Find<ModItem>("OmniTurretItem").Type, 1);
            r.AddIngredient(ItemID.Cog, 10);
            r.AddTile(TileID.WorkBenches);
            r.Register();

            //Matter projector
            r = Recipe.Create(PlaceItems[2].Type, 1);
            r.AddIngredient(Mod.Find<ModItem>("SuperOmniTurretItem").Type, 1);
